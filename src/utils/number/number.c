...
void resolverMillones(int num, char *string)
{
    ...
    if (atoi(millonesText) > 1)
        sprintf(string, "%s millones %s", millonesInLetter, milesInLetter);
    else
        sprintf(string, "un millon %s", milesText);
...
void resolverMiles(int num, char *string)
{
    ...
    if (atoi(milesText) > 1)
        sprintf(string, "%s mil %s", milesInLetter, centenasInLetter);
    else if (atoi(milesText) == 1)
        sprintf(string, "mil %s", centenasInLetter);
    else
        sprintf(string, "%s", centenasInLetter);
...
void resolverCentenas(int num, char *string)
{
    ...
    if (num / 100 > 0)
        sprintf(string, "%s %s", centenas[num / 100], decenas);
    else
        sprintf(string, "%s", decenas);
}
...
void resolverDecenas(int num, char *string)
{
    ...
    if (strlen(unidades) > 0)
        sprintf(string, "%s y %s", decenas[num / 10], unidades);
    else
        sprintf(string, "%s", decenas[num / 10]);
}
